...
def extract_folio_number(text):
    # Define the regex pattern to match the folio number
    pattern = r'Folio Number:\s*(\d+ / \S+|\d+)'
...
Statement Date: 16-Aug-2024 Folio Number: 1017662402 / @Nominee 2: Not Applicable
